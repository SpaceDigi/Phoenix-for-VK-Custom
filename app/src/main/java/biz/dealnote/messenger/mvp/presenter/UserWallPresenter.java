...
public class UserWallPresenter extends AbsWallPresenter<IUserWallView> {
    ...
    public void fireMoreInfoClick() {
        // TODO: 18.09.2017
        //Of course will be but I have not API
        //Added toast-message for informing user about this bug
        Toast.makeText(getApplicationContext(),R.string.not_yet_implemented_message,Toast.LENGTH_LONG).show();
    }
