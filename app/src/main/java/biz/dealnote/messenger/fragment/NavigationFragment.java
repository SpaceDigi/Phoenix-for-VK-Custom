...
public class NavigationFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //replace ivHeaderAvatar to vHeader,
        // so now we can open profile page by click on all background -> not only by click on image of profile
        vHeader.setOnClickListener(v -> {
            closeDrawer();
            openMyWall();
        });
    ...
    public void appendRecentChat(@NonNull RecentChat recentChat) {
        ...
        if (index != -1) {
            ...
            ///////////////////////////////////////////
            //Предложение - добавить так, чтобы по долгому клику не открывало переписку,
            // а удаляло этого человека из "Недавних переписок"
            //////////////////////////////////////////
